...
const features = [
  ...
  { feature: 'Build a "how well do you know me?" quiz with a private scoreboard', us: true, dll: false, paperless: false, hallmark: false, canva: false, docs: false },
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <div className="bg-rose-600 rounded-2xl p-6 shadow-sm text-white md:col-span-2 lg:col-span-1">
              ...
              <ul className="text-sm text-rose-100 space-y-1.5 leading-relaxed">
                ...
                <li>✓ Make a &ldquo;how well do you know me?&rdquo; quiz and see everyone&rsquo;s scores on a private scoreboard</li>
