      ...
      <main className="flex-1 max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-rose max-w-none space-y-10 text-rose-800/80">
          <section>
            ...
            <p>By accessing or using Heartfelt Letters, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our service.</p>
          </section>

          <section>
            <h2 className="font-serif text-2xl font-bold text-rose-900 mb-3">2. Description of Service</h2>
            <p>Heartfelt Letters is a web application that allows users to compose, store, and share personal letters. We provide letter templates, a rich text editor, and shareable links for distribution.</p>
          </section>
          ...
          <section>
            ...
            <p>You agree not to use Heartfelt Letters to: send spam or unsolicited messages; harass, threaten, or harm others; post illegal content or content that infringes on others&apos; rights; attempt to gain unauthorized access to our systems; or use our service in any way that violates applicable laws.</p>
          </section>

          <section>
            <h2 className="font-serif text-2xl font-bold text-rose-900 mb-3">6. Content Ownership</h2>
            <p>You retain ownership of the content you create using Heartfelt Letters. By using our service, you grant us a limited license to store and display your content as necessary to provide the service. We do not claim any ownership over your letters.</p>
          </section>

          <section>
            <h2 className="font-serif text-2xl font-bold text-rose-900 mb-3">7. Privacy</h2>
            <p>Your use of Heartfelt Letters is also governed by our Privacy Policy, which is incorporated into these Terms by reference. Please review our Privacy Policy to understand our practices.</p>
          </section>

          <section>
            <h2 className="font-serif text-2xl font-bold text-rose-900 mb-3">8. Disclaimer of Warranties</h2>
            <p>Heartfelt Letters is provided &quot;as is&quot; without any warranties, express or implied. We do not guarantee that our service will be uninterrupted, error-free, or completely secure. We are not responsible for any loss of data.</p>
          </section>

          <section>
            <h2 className="font-serif text-2xl font-bold text-rose-900 mb-3">9. Limitation of Liability</h2>
            <p>To the maximum extent permitted by law, Heartfelt Letters shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of our service, even if we have been advised of the possibility of such damages.</p>
          </section>
          ...
          <section>
            ...
            <p>If you have questions about these Terms, please contact us at <a href="mailto:hello@heartfeltletters.app" className="text-rose-600 underline">hello@heartfeltletters.app</a>.</p>
          </section>
        </div>
      </main>
      <Footer />
