...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Can I write a love letter without signing up?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Guests can write and share a letter with no account at all. A guest link expires after 7 days; a free account keeps the letter for 30 days and emails you when it is opened and whenever a reply arrives. You can sign up after sending and keep the letter you just wrote.' } },
