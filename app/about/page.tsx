        ...
        <section className="py-20 px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-rose max-w-none text-rose-800/80 leading-relaxed space-y-4">
              ...
              <p>
                That matters mostly because of what it rules out. Letter content is encrypted with AES-256 before it reaches our database, so a stolen copy of that database is unreadable. We do not sell or share letter content, we do not place advertising inside the letters themselves, and we do not harvest the addresses of people who open a letter you sent them. To be precise about what that does and does not mean: this is encryption at rest, not end-to-end encryption. We hold the key, because the letter has to be decrypted to show it to the person you sent it to. It protects your letter from a breach and from anyone who is not us — it is not a mathematical guarantee against us, and a site that claims otherwise while still rendering your letter in a browser is overstating its own architecture.
              </p>
              <p>
