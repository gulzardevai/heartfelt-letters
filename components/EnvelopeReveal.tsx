...
export default function EnvelopeReveal({ letter }: { letter: Letter }) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 bg-gradient-to-br from-rose-50 via-cream to-pink-50 overflow-hidden">
      <div
        ...
        <div className="envelope">
          ...
          <div className="envelope-letter">
            <div className="envelope-letter-inner">
              <p className="font-serif text-rose-900 text-sm italic leading-relaxed px-6 pt-5 text-center">
          ...
          <div className="envelope-front">
            <div className="text-center">
              {letter.recipient_name && (
                <p className="font-cursive text-2xl text-rose-800 mb-1">For {letter.recipient_name}</p>
              )}
              <p className="text-rose-400 text-xs tracking-widest uppercase">{stage === 'closed' ? 'Tap to open' : ''}</p>
            </div>
          </div>
